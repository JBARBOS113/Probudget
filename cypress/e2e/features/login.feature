Feature: We need to select de aplication 

    People need to select the aplication when us going to uses some options
    Background: 
    Given validate de url for this page
    Scenario: The client need to find this page
